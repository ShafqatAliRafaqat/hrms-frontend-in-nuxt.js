...
export default {
  ...
  computed: {
    formTitle () {
      return this.editedIndex === -1 ? 'New Modification' : 'Edit Modification'
    }
  },
  created () {
    this.getList()
    ...
    async save () {
      if(this.$refs.form.validate()) {
        if (this.editedIndex > -1) {
          let data={
            path:"/modification/"+this.editedItem.id,
